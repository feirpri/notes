...
这可能是一个 FEvent 私有的属性，比如在 Vue 里面，他叫 _events,
如果期望借用 Vue 的 event 实现，可能的代码长这样：
```javascript
class A extends Vue {
	constructor(){
		this._events = {};
...
但是这不是标准用法，—events
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU3OTY2NTQzLC0xMzUxNzk2MzkzLDE1Mz
E1NzUxNzAsLTEzMzI1MzM2NTAsLTk4MDY2MzY5NiwtMTA0MjA3
NzEwMiw3NDQ1ODE2NTcsLTY5NjQwMDczNCwtMTQyOTY3OTcyNV
19
-->